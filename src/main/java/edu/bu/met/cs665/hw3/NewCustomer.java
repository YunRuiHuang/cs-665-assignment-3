 ...
 * Description: This class defines a New customer who can create various types of emails.
 */
...
public class NewCustomer extends Customer {
    ...
    /**
     * Constructs a NewCustomer object with the specified recipient.
     * @param recipient The recipient's email address.
     */
    public NewCustomer(String recipient) {
